...
const appName = 'FlClash 二次开发';
const appHelperService = 'FlClashDevHelperService';
const coreManifestName = 'manifest.json';
const coreName = 'clash.meta';
const browserUa =
    'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36';
const packageName = 'com.wzpxx.flclash.dev';
final unixSocketPath = '/tmp/FlClashDevSocket_${Random().nextInt(10000)}.sock';
final windowsPipeName = '\\\\.\\pipe\\FlClashDevCore_${_randomPipeId()}';
...
const defaultExternalController = '127.0.0.1:9190';
...
const mainIsolate = 'FlClashDevMainIsolate';

const serviceIsolate = 'FlClashDevServiceIsolate';
